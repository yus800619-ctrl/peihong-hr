...
window.showPage=async n=>{if(n==='admin'&&!hrLoginPrompt())return;document.querySelectorAll('.page').forEach(p=>p.classList.add('hide'));$('page-'+n).classList.remove('hide');const showVersion=n==='admin';$('versionTopBanner')?.classList.toggle('hide',!showVersion);$('versionInfoCard')?.classList.toggle('hide',!showVersion);if(n==='employee')await tryRestoreEmployeeLogin();if(n==='admin')await loadAdminAll()};
