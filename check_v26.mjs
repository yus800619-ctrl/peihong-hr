...
const createClient = (...args)=>({from(){return this},select(){return this},eq(){return this},gte(){return this},lt(){return this},order(){return this},limit(){return this},insert(){return this},update(){return this},delete(){return this},single(){return this},rpc(){return this}});
...
window.editEmployee = function(id){
  ...
  $('editEmpLaborInsuredSalary').value = e.labor_insured_salary || 0;
  $('editEmpHealthInsuredSalary').value = e.health_insured_salary || 0;
...
function halfHourFloor(hours){ return Math.floor(Math.max(0, num(hours)) * 2) / 2; }
...
window.submitOvertime = async function(){
  ...
  if(!date || !start || !end || hours <= 0) return msg('請填寫正確加班日期與時間；平日加班從17:00後起算，且至少需滿0.5小時','bad');
